...
import { Product, useGetProductsQuery, useUpdateProductMutation } from "@/state/api";
...
const Inventory = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      ...
      <Box mt="20px" height="75vh" sx={{ "& .MuiDataGrid-root": { border: "none" } }}>
        <DataGrid
          ...
          checkboxSelection
          onRowSelectionModelChange={handleRowSelection} // Corrected prop for row selection
      ...
      <Modal open={openRestockModal} onClose={handleCloseRestockModal}>
        ...
        >
          ...
          <Box mt="1rem" display="flex" justifyContent="space-between">
            ...
            <Button onClick={handleRestockProducts} color="primary" variant="contained">
              Confirm
            </Button>
          </Box>
        </Box>
