...
import { CheckCircle, Add, Remove, Visibility, Star, StarBorder } from "@mui/icons-material";
        ...
        renderCell: (params) => {
          ...
          return (
            <Box sx={{ display: "flex", justifyContent: "center", width: "100%" }}>
              ...
              >
                {isFeatured ? <Star fontSize="small" /> : <StarBorder fontSize="small" />}
              </IconButton>
            </Box>
          );
        },
        valueGetter: (params) => featuredProducts.has(params.row.productId) ? 1 : 0,
      },
      {
        field: "image",
        headerName: "Image",
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={7}>
                    ...
                    <Box sx={{ mt: 3, display: 'flex', alignItems: 'center' }}>
                      ...
                      <Button
                        startIcon={featuredProducts.has(selectedViewProduct.productId) ? 
                          <Star sx={{ color: 'gold' }} /> : 
                          <StarBorder />
                        }
                        variant="outlined"
